...
def eye_model():
    ...
    materials = EyeMaterials(
        cornea=MaterialModel(
            refractive_index=1.3777, abbe_number=0, partial_dispersion=0
        ),
        aqueous=MaterialModel(
            refractive_index=1.3391, abbe_number=0, partial_dispersion=0
        ),
        lens=MaterialModel(
            refractive_index=1.4222, abbe_number=0, partial_dispersion=0
        ),
        vitreous=MaterialModel(
            refractive_index=1.3377, abbe_number=0, partial_dispersion=0
        ),
    )
...
class TestOpticStudioEye:
    ...
    def test_build_cornea_front(self, new_oss, eye_model):
        ...
        assert opticstudio_eye.cornea_front.thickness == pytest.approx(
            eye_model.geometry.cornea_front.thickness
        )
        assert opticstudio_eye.cornea_front.radius == pytest.approx(
            eye_model.geometry.cornea_front.radius
        )
        assert opticstudio_eye.cornea_front.conic == pytest.approx(
    ...
    def test_build_cornea_back(self, new_oss, eye_model):
        ...
        assert opticstudio_eye.cornea_back.thickness == pytest.approx(
            eye_model.geometry.cornea_back.thickness
        )
        assert opticstudio_eye.cornea_back.radius == pytest.approx(
            eye_model.geometry.cornea_back.radius
        )
        assert opticstudio_eye.cornea_back.conic == pytest.approx(
    ...
    def test_build_pupil(self, new_oss, eye_model):
        ...
        assert opticstudio_eye.pupil.semi_diameter == pytest.approx(
            eye_model.geometry.pupil.semi_diameter
        )
    ...
    def test_build_lens_front(self, new_oss, eye_model):
        ...
        assert opticstudio_eye.lens_front.thickness == pytest.approx(
            eye_model.geometry.lens_front.thickness
        )
        assert opticstudio_eye.lens_front.radius == pytest.approx(
            eye_model.geometry.lens_front.radius
        )
        assert opticstudio_eye.lens_front.conic == pytest.approx(
    ...
    def test_build_lens_back(self, new_oss, eye_model):
        ...
        assert opticstudio_eye.lens_back.thickness == pytest.approx(
            eye_model.geometry.lens_back.thickness
        )
        assert opticstudio_eye.lens_back.radius == pytest.approx(
            eye_model.geometry.lens_back.radius
        )
        assert opticstudio_eye.lens_back.conic == pytest.approx(
    ...
    def test_build_retina(self, new_oss, eye_model):
        ...
        assert opticstudio_eye.retina.radius == pytest.approx(
            eye_model.geometry.retina.radius
        )
        assert opticstudio_eye.retina.conic == pytest.approx(
    ...
    def test_update_surfaces_subset(self, new_oss, eye_model):
        ...
        opticstudio_eye.update_surfaces(
            "comment", "new comment", surfaces=["cornea_front", "lens_back"]
        )
